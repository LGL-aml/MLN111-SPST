...
export const answer = action({
  ...
  handler: async (ctx, args) => {
    ...
    // Lưu ý: một số model (ví dụ gemini-1.5-flash) không hỗ trợ generateContent trên v1beta,
    // nên ta ghim apiVersion = "v1" để tránh lỗi 404 "not supported for generateContent".
